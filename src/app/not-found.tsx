    ...
    <>
      ...
      <section className="min-h-[60vh] flex items-center justify-center px-8 md:px-16 bg-warm-white">
        <div className="text-center max-w-md">
          <p className="font-serif text-7xl md:text-8xl font-semibold text-sandy-dark mb-4">
            404
          </p>
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 bg-terra hover:bg-terra-light text-white px-8 py-4 rounded-lg text-sm tracking-[0.08em] uppercase transition-colors duration-150"
          >
            Return Home
            <svg
              className="w-4 h-4"
