...
export default function PropertyCard({
  ...
  return (
    <div className="property-card group relative overflow-hidden rounded-xl bg-white border border-sandy-dark/40 hover:shadow-xl cursor-pointer transition-shadow duration-300">
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        {isSold ? (
          <div className="absolute top-4 left-4 bg-terra text-white text-[10px] font-bold tracking-[0.15em] uppercase px-3 py-1.5 rounded-md">
            Sold
          </div>
        ) : null}
